DROP TRIGGER IF EXISTS documents_t_documents_trg_log_document_visibility_changed_to_pr
ON documents.t_documents;

CREATE TRIGGER documents_t_documents_trg_log_document_visibility_changed_to_pr
