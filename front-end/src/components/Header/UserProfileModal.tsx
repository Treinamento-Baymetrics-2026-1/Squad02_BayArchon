        ...
        <div className="px-8 pb-8">
          ...
          <div className="space-y-4">
            <div className="bg-white border border-bordaoff-white rounded-xl p-4 flex items-center gap-4 shadow-sm">
              ...
              <div>
                <p className="text-[13px] font-medium text-azul-corporativo">
                  Setor
                </p>
                <p className="text-[16px] font-medium text-preto-suave mt-0.5">
                  Recursos Humanos
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-8">
            ...
            <Button className="h-10 px-6 rounded-lg bg-azul-corporativo hover:bg-azul-marinho text-white font-medium flex items-center gap-2">
              <PencilIcon
